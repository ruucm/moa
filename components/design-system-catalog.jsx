...
import { Badge, Callout, Checks, DataTable, Figure, FooterNote, Issues, Lessons, MediaGrid, Progress, Rules, Stats, Timeline, Updated } from './report/index.jsx'
  ...
  return (
    <div className={styles.catalog}>
      ...
      <section className={styles.section} aria-labelledby="catalog-reports">
        ...
        <Example title="Figure · One image with a caption" description="src / cap / wide / video · Click or press Enter to open the image viewer" wide><Figure src={imageExample} cap="Example image for design review · click it to open the viewer." /></Example>
        <Example title="MediaGrid · Images and video" description="items[].src / cap / video, cols · Reflows on narrow screens · Images are click-to-zoom" wide><MediaGrid cols={2} items={[{ src: imageExample, cap: 'Example image for design review · not an actual report.' }, { src: videoExample, video: true, cap: 'Example video for design review · 2 seconds, no audio.' }]} /></Example>
